...
enum LGState{
    ...
    VERTICAL_TWO_THIRDS_LEFT,
    VERTICAL_TWO_THIRDS_RIGHT,
    HORIZONTAL_TWO_THIRDS_TOP,
    HORIZONAL_TWO_THIRDS_BOTTOM,
    FOURTH_TOP_LEFT,
    FOURTH_TOP_RIGHT,
    FOURTH_BOTTOM_LEFT,
    FOURTH_BOTTOM_RIGHT,
    ...
    SIXTH_BOTTOM_RIGHT,
    TWO_SIXTHS_TOP_LEFT,
    TWO_SIXTHS_TOP_RIGHT,
    TWO_SIXTHS_BOTTOM_LEFT,
    TWO_SIXTHS_BOTTOM_RIGHT,
    NINTH_TOP_LEFT,
    NINTH_TOP_MIDDLE,
    NINTH_TOP_RIGHT,
    NINTH_MIDDLE_LEFT,
